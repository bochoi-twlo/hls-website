...
output "replace YOUR_WORKFLOW_SID       -> ${WORKFLOW_SID}"
output "replace YOUR_TASK_CHANNEL_SID   -> ${TASK_CHANNEL_SID}"
...
-e "s/YOUR_WORKFLOW_SID/${WORKFLOW_SID}/g" \
-e "s/YOUR_TASK_CHANNEL_SID/${TASK_CHANNEL_SID}/g" \
